...
for n_cells in DATASET_CELL_COUNTS:
...
# Write to pickle
with open(
    f"{data_cache_dir}/norman19_pert_normalized_abs_scores_vsrest_cells_per_pert.pkl",
    "wb",
) as f:
    pickle.dump(pert_normalized_abs_scores_vsrest_cells_per_pert, f)
with open(
    f"{data_cache_dir}/norman19_pert_normalized_abs_scores_vsrest_cells_per_pert_selectedcells.pkl",
    "wb",
) as f:
